...
<body>
    ...
    {{-- <p class="text-2xl font-bold text-center">Aplikasi Toko ATK Ryan</p> --}}
    <nav class="bg-white border-gray-200 dark:bg-gray">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="https://flowbite.com/" class="flex items-center space-x-3 rtl:space-x-reverse">
                <img src="https://flowbite.com/docs/images/logo.svg" class="h-8" alt="Flowbite Logo" />
                <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Aplikasi Toko ATK
                    Ryan</span>
            </a>
            ...
            <div class="hidden w-full md:block md:w-auto" id="navbar-default">
                <ul
                    ...
                    <li>
                        <a href="#"
                            class="block py-2 px-3 text-white text-gray-900 bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 dark:text-white md:dark:text-blue-500"
    ...
    <div class="max-w-screen-md mx-auto p-3 mt-8 bg-white">
            ...
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                ...
                <tbody class="text-base">
                    ...
                    <tr
                        ...
                        <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">{{ $barangs->nama_barang }}"</th>
                        <td class="px-6 py-4">{{ $barangs->kategori }}</td>
                        <td class="px-6 py-4">{{ 'Rp ' . number_format($barangs->harga, 0, ',', '.') }}</td>
                        <td class="px-6 py-4">{{ $barangs->stok }}</td>
                        <td class="px-6 py-4">
    ...
    <footer class="w-full p-4 bg-white border-t dark:bg-gray-900 dark:border-gray-700">
        <div class="w-full max-w-screen-xl mx-auto p-4 md:py-8">
            <div class="sm:flex sm:items-center sm:justify-between">
                <a href="https://flowbite.com/" class="flex items-center mb-4 sm:mb-0 space-x-3 rtl:space-x-reverse">
                    <img src="https://flowbite.com/docs/images/logo.svg" class="h-8" alt="Flowbite Logo" />
                    <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Aplikasi Toko
                        ATK Ryan</span>
                </a>
                <ul
            ...
            <span class="block text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a
                    href="https://flowbite.com/" class="hover:underline">Aplikasi Toko ATK Ryan</a>. All Rights
                Reserved.</span>
        </div>
    </footer>
